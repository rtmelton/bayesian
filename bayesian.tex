...
Also, by the proof of Proposition~\ref{marginal_abscont},
\begin{align*}
...
Also, for the following ratios of Radon-Nikodym derivatives, define:
\begin{align*}
...
\textbf{You have two propositions here; separate them. (1) If absolute continuity holds, then the conditional distributions are regular. This is just a corollary to earlier work. (2) If the conditional distributions are regular, then the following are equivalent.}

\textbf{Look, if $\mu$ and $\nu$ are \textsigma\hyp{}finite, then $\mu\times\nu$ is
\textsigma\hyp{}finite. It just is. Remove the statement. Get some sleep.}
