...
\begin{rmk}
Some implications may be used without much fanfare; namely, if the classes $\ellclass{\function}{\measure}$ and
...
is  the unique orthogonal projection of the Hilbert space $L_2(\measurespace, \sigmaalgebra,\measure)$ onto the closed subspace
$\L1embedding
\bigl(
...
$\lebclass{\funcf} \in L_2(\measurespace, \sigmaalgebra,\measure)$
there corresponds a unique element of
$\hilbertsubspace$,
in this case
$\condexpsub{\lebclass{\funcf}}{\sigmaalgebraii}$,
such that
$\lebclass{\funcf} - \condexpsub{\lebclass{\funcf}}{\sigmaalgebraii}
\perp
\lebclass{\funch}$ for all
$\lebclass{\funch} \in
\hilbertsubspace $, for then the map
$\lebclass{\funcf}
\mapsto
\condexpsub{\lebclass{\funcf}}{\sigmaalgebraii}$
