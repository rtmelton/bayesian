...
By the proof of Proposition~\ref{reference_implies_marginals},
\begin{align*}
...
\frac{p(x,z)}{p(z)}.
\]
By Proposition~\ref{reference_implies_mixed_and_marginals} and Proposition~\ref{conditional_density},
if $h(u)=z$, then
\[
