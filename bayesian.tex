...
\kondexpsub{\ellclass{\funcg}{\measmu}}{\sigalg{B}}.
\]
This says that the equivalence classes
$\ellclass{e}{\measure\restrictedto{\sigmaalgebraii}}$
and
$\kondexpsub{\ellclass{\functionii}{\measure}}{\sigalg{B}}$ of
$L_1(\measurespace, \sigmaalgebraii,\measure\restrictedto{\sigmaalgebraii})$
are the same; that is,
\[
\ellclass{e}{\measure\restrictedto{\sigmaalgebraii}}
=
\kondexpsub{\ellclass{\functionii}{\measure}}{\sigalg{B}}.
\]

\textbf{Okay to here. Re-do the long string of equalities below with $B$ and $C$ both in
$\sigmaalgebraii$.  Then apply Poroposition~\ref{submeasurable_step_function} and the linearity and continuity of the integral.}
