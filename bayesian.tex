...
\begin{prop}
Let $\{\hortho, \horthoii, \ldots, \horthon\}$ be an orthonormal set in a Hilbert space $\hilbertspace$, and let $\proj:\hilbertspace \to \hilbertspace$ be the orthogonal projection of $\hilbertspace$ onto the
...
\in
L_1(\measurespace, \sigmaalgebraii,\measure\restrictedto{\sigmaalgebraii})$,
and so by Proposition~\ref{subalgebra_fixed},
\[
\condexpsub{\ellclass{\function}{\measure}}{\sigmaalgebraii}
=
