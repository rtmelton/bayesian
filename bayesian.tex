...
Let us say that an
$(\sigmaalgebra, \borel_\R)$\hyp{}simple function is an
$(\sigmaalgebra,\borel_\R)$\hyp{}\term{step function} if it can be expressed as a linear combination of characteristic functions of subsets of $\sigmaalgebra$ of finite
$\measmu^\kernast$\hyp{}measure.  That is,  if $\phi$ is an
...
$\seti_i \in \sigmaalgebra$, and with $\measmu^*(A_i) < \infty$,
...
is in
$L_1(\measurespace, \sigmaalgebra,\measmu)$, then
\[
