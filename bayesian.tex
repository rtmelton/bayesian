...
\begin{notn}
In some of the literature, you may see the density
$d \funck_\uspaceelt / d \measure$,
where $\funch(u)=z$,
described as representing ``the conditional distribution of $\funcf$ given $\funch = z$'' with notation such as
$p(x\mid z)$
or possibly something like
$\measlambda_{f\vert h=z}$.
\end{notn}
