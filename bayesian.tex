...
Call the measurable space
$(\measurespace, \sigmaalgebra)$
the \emph{attribute space}, or \emph{parameter space}, and call the measurable space
$(\measurespaceii, \sigmaalgebraii)$
the \emph{sample space}.

***************

Let $\funcf$ and $\funcg$ denote the respective coordinate projections of
