...
\measurespace
\}$
with $\measure$ being Dirac measure $\diracmeasure{\mspaceelt}$ concentrated at a point $\mspaceelt\in\seti$, with $\seti$ non-empty, and with $\seti$ not equal to $\measurespace$.
Let
$\sigmaalgebraii = 
\{ 
\mtset,
...
\textbf{Need to look in a little more depth at this proof.}
