...
$\measonprod\abscont (\marginalone\times\marginaltwo)^*$.
Then both the sampling conditional distribution and the posterior conditional distribution are regular. This is just what Proposition~\ref{marginal_implies_regular} says.
