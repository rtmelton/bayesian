...
$\measmu\circ\preimage{\funcf}$ is absolutely continuous with respect to some reference measure
$\measlambda$ on $\borel_\R$,
with $p$, say, representing the corresponding Radon-Nikodym derivative, then the expected value can be found by
\[
...
$\measmu\circ\preimage{\funcf}$.  By a change of variable,
\[
...
\begin{notn}
In some of the literature, you might see the density
$d \funck_\uspaceelt / d \measure$,
where $\funch(\uspaceelt) = \mspaceeltiii$,
described as representing ``the conditional distribution of $\funcf$ given
$\funch = \mspaceeltiii$'' with notation such as
