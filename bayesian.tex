...
\]
If  $\measmu\circ\preimage{\funcf}$ is absolutely continuous with respect to a reference measure
...
\]
You \emph{could} compute the expected value this way.

Throw in the missing detail by way of Proposition~\ref{radon_nikodym_corollary}.
\end{rmk}
