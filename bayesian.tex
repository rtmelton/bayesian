...
\begin{proof}
Let
$\measonprod\abscont (\measmu\times\marginalthree)^*$, with a reminder that $\measmu$ is a reference measure on $\sigmaalgebra$, and $\marginalthree$ is a marginal measure on
$\sigmaalgebraiii$.
We are letting
$\funck$
denote the corresponding Markov kernel given
