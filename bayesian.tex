...
$\sigmaalgebra$.
Also, let $\sigmaalgebraiii$ and $\sigmaalgebraiv$ be \textsigma-subalgebras of $\sigmaalgebra$.
Since $\sigmaalgebraii$ is supposed to be a \textsigma\hyp{}subalgebra of $\sigmaalgebra$, it means that $\sigmaalgebraii$ lies somewhere in the lattice of \textsigma\hyp{}subalgebras of $\sigmaalgebra$ between the smallest and the largest, that is
\[
\{\measurespace, \mtset\}
\leq \sigmaalgebraii
\leq
\sigmaalgebra.
\]
Let us try to understand conditional independence in the two cases
$\sigmaalgebraii
=
\{\measurespace, \mtset\}$
and
