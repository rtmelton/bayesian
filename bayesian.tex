...
Be forewarned that the following definition of a
\emph{regular conditional probability distribution}
is nothing but the definition of a regular conditional probability combined with a preimage.
...
\ellclass{r \circ \funcf}{\measlambda\restrictedto{\sigalg{F}}}
\]
We are calling the induced function $r$ the \term{regression function}.
