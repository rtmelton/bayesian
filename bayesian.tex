...
$(\mkernel{\measureiii}{\function}{\functioniii})^\seti$ factors as some function $r$ composed with $\functioniii$,
...
And by the definition of the Markov kernel itself:
\[
...
\] 
The value of this measure on $\seti\in\sigmaalgebra$ relates to the function $r$:
\[
...
\begin{defnboldnote}[Conditional independence]\label{conditionally_independent}
Let
$(\measurespace,\sigmaalgebra,\measure)$
be a probability space, and let $\sigmaalgebraii$ be a  $\textsigma$-subalgebra of 
$\sigmaalgebra$.
