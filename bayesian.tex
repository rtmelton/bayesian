...
\]
where $\mspaceeltiii$ is such that $\funch(\uspaceelt) = \mspaceeltiii$.
\end{propboldnote}
...
then the measure
$\funck_\uspaceelt$
on $\sigmaalgebra$, where $\mspaceeltiii$ is such that $\funch(\uspaceelt)=\mspaceeltiii$,
