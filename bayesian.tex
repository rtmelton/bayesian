...
$\{ \phi_n \}$ of
$(\sigmaalgebraii,\borel_\R)$\hyp{}step functions such that
$\phi_n(x)\geq 0$ and $\phi_n(x)\uparrow f(x)$ for all $x\in\measurespace$.
...
This says $\{\phi_n\}$ is a sequence of $(\measurable{\measuresubstar{\sigmaalgebraii}},\borel_\R)$-step functions with
$\phi_n(x) \uparrow f(x)$ for all $x\in\measurespace$. In order to complete the proof that $f$ is integrable with respect to $\measure\restrictedto{\sigmaalgebraii}$, it is sufficient to show that
