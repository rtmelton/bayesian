...
$\textsigma$\hyp{}algebra, as opposed to merely a semi\hyp{}ring.
...
\]
as in the following proposition, took some effort, as tracing back through at least Proposition~\ref{integral_over_subalgebra}, shows.
...
\textbf{The proof of a monotone convergence theorem for conditional expectation is interesting enough to include here, and will be used in the projections chapter.}
\end{prop}
...
$\L1embedding\bigl(
L_2(\measurespace, \sigmaalgebraii,\measmu\restrictedto{\sigmaalgebraii})
\bigr)$, which is the collection of those classes of
$L_2(\measurespace, \sigmaalgebra, \measmu)$
which have a
$(\sigmaalgebraii,\borel_\R)$\hyp{}measurable representative.
